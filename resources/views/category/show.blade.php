<x-main-layout>
    ...
    <div class="flex flex-wrap text-center py-2">
        <a href="{{ route('subcategory.create', ['category_id' => $category->id, 'visibility' => $visibility]) }}" class="w-2/4 border-r-2">
            Dodaj podkategorię
        </a>
        <a href="{{ route('page.create', ['parent' => 'category', 'id' => $category->id, 'visibility' => $visibility]) }}" class="w-2/4">
            Dodaj stronę
        </a>
    </div>
    {{-- Podkategorie --}}
